         ...
         <div class="col-md">
            <div class="card-body bg-white border shadow" style="border-radius: 10px">
               <div class="card-header bg-white">
                  <h5>Tutorial Ganti Baterai HP-CM0077AU</h5>
               </div>
               <div class="card-body ">
                  ...
                  <div class="text-center ">
                     ...
                     <iframe class="w-100" src="https://youtube.com/embed/69S4b_wxL3M" width="420" height="315"  title="YouTube video player"  frameborder="0" allow="accelerometer;autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                     {{-- <iframe  width="420" height="315" src="https://www.youtube.com/embed/69S4b_wxL3M" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> --}}
                  </div>
                  <p class="py-2">
