         ...
         <div class="col-md">
            <div class="card-body bg-white border shadow" style="border-radius: 10px">
               <div class="card-header bg-white">
                  <h5>{{ $laptop->title }}</h5>
                  <p>By : {{ $laptop->author->username }} in <a href="/categories_laptop/{{ $laptop->category->slug }}">{{ $laptop->category->name }}</a></p>
               </div>
               <div class="card-body ">
                  ...
                  <div class="text-center">
                     <img src="/image/laptop/acer/acer_nitro.jpg" alt="" width="100%">
                  </div>
                  <p class="py-2">
