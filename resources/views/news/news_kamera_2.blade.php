         ...
         <div class="col-md">
            <div class="card-body bg-white border shadow" style="border-radius: 10px">
               <div class="card-header bg-white">
                  <h5>Smartphone dengan kamera 200 MP terbaik tahun 2022</h5>
               </div>
               <div class="card-body ">
                  ...
                  <div class="bg-white border">
                     <div class="row row-cols-2 px-3 py-3">
                        ...
                        <div class="avatar  d-flex align-items-center text-md-start text-center justify-content-center">
                           <img class="rounded-circle " width="100%" src="image/logo-merah.png" alt="" style="border:1px solid blue">
                        </div>
                     ...
                     <div class="row row-cols-2 pb-3 px-3">
                        ...
                        <div class="avatar  d-flex align-items-center ">
                           <img class="rounded-circle " width="100%" src="image/logo-merah.png" alt="" style="font-size:16px;border:1px solid blue">
                        </div>
                        <div class=" about text-start ">
